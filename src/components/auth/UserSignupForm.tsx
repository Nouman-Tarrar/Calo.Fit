...
const UserSignupForm = ({ onSubmit }: UserSignupFormProps) => {
  ...
  const handleSocialAuth = (method: "google" | "facebook") => {
    ...
    return (
      <Card className="w-full max-w-md shadow-xl border-none">
        <CardHeader className="text-center">
          ...
          <CardDescription>Join NutriOrder and start your healthy eating journey</CardDescription>
        </CardHeader>
      ...
      <CardHeader className="text-center">
        ...
        <CardDescription>
          {authMethod === "email" 
            ...
            : `Complete your ${authMethod} sign up`
          }
        </CardDescription>
      </CardHeader>
      <CardContent>
